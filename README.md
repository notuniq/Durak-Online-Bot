...
### Алгоритм работы (Доработал [evg3n1y-btw](https://github.com/evg3n1y-btw))
- Создание нового аккаунта с iOS устройства
- Добавление этого аккаунта вам в друзья
- Создание 3 комнаты 1 на 1 на 2500 и два раза по 1000 (по очереди)
...
- bet1 = 2500 - ставка первой игры
- bet2 = 1000 - ставка второй игры
- bet3 = 1000 - ставка третьей игры
Далее
